...
const PERSONAS = [
  {
    ...
    description: 'Friendly and patient tutor. Loves talking about travel, food, and culture.',
  ...
  },
  {
    ...
    description: 'Professional and articulate. Great for practicing business English and formal topics.',
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl mb-4">Choose Your Conversation Partner</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Select an AI persona to start practicing. Each partner has a unique personality and teaching style.
        </p>
      </div>
